...
Scenario: Invalid Payee
      ...
      And he enters "100" as amount
      And he Submits request for Fund Transfer
      Then ensure a transaction failure message "Transfer fffffffailed!! 'John' is not approved. Please contact your branch" is displayed
